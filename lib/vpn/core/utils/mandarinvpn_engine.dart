...
class MandarinVpnEngine {
  ///Channel to native
  static final String _eventChannelVpnStage = "id.mandarin.vpn/vpnstage";
  static final String _eventChannelVpnStatus = "id.mandarin.vpn/vpnstatus";
  static final String _methodChannelVpnControl = "id.mandarin.vpn/vpncontrol";
